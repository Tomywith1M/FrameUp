...
import 'package:frameup/components/Opinions/opinion_screen.dart';
...
class PostCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final userData = FrameUser.fromMap(actorData as Map<String, dynamic>);
...
class __PictureCarousalState extends State<_PictureCarousal> {
  late var starReactions = getLikeReactions() ?? [];
  ...
  Future<void> _addLikeReaction() async {
    ...
    setState(() {
      starReactions.add(latestLikeReaction!);
      likeCount++;
    });
  }
  ...
  Future<void> _removeLikeReaction() async {
    ...
    setState(() {
      starReactions.removeWhere((element) => element.id == reactionId);
      likeCount--;
        ...
        children: [
          ...
          Padding(
            ...
            child: FavoriteIconButton(
              isfavorite: widget.enrichedActivity.ownReactions?['like'] != null,
              onTap: (liked) {
                if (liked) {
                  _addLikeReaction();
                } else {
              ...
              onTap: () {
                ...
                Navigator.of(context).push(
                  OpinionScreen.route(
                    ...
                    activityOwnerData: FrameUser.fromMap(map),
                  ),
                );
              },
      ...
      return Padding(
        ...
        child: Text.rich(
          TextSpan(
            ...
            children: <TextSpan>[
              TextSpan(
                  text: FrameUser.fromMap(
                          starReactions[0].user?.data as Map<String, dynamic>)
                      .fullName,
              ...
              if (likeCount > 1 && likeCount < 3) ...[
                ...
                TextSpan(
                    text: FrameUser.fromMap(
                            starReactions[1].user?.data as Map<String, dynamic>)
                        .fullName,
                    style: AppTextStyle.textStyleBold),
              ],
              if (likeCount > 3) ...[
          ...
          Padding(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                // AND THIS
                Navigator.of(context).push(OpinionScreen.route(
                  enrichedActivity: widget.enrichedActivity,
                  activityOwnerData: FrameUser.fromMap(map),
                ));
              },
...
class _ProfilePicture extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final frameUser = context.watch<AppState>().frameUser;
    if (frameUser == null) {
      return const Icon(Icons.error);
    }
    return Character.small(
      frameUser: frameUser,
    );
  }
}
...
class _ProfileSlab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Character.medium(frameUser: userData),
          Padding(
